...
func (m *MockCar) CarCreate(arg0 *gofr.Context, arg1 *models.Car) (*models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarGet(arg0 *gofr.Context, arg1 uuid.UUID) (*models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarGetByBrand(arg0 *gofr.Context, arg1 string, arg2 bool) ([]*models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarUpdate(arg0 *gofr.Context, arg1 *models.Car) (*models.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineCreate(arg0 *gofr.Context, arg1 *models.Engine) (*models.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineGet(arg0 *gofr.Context, arg1 uuid.UUID) (*models.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineUpdate(arg0 *gofr.Context, arg1 *models.Engine) (*models.Engine, error) {
	m.ctrl.T.Helper()
